...
This module compresses and decompresses the jsonData as fast as you feed
...
If you write, jsonData will be emitted right away.  If you write
everything synchronously in one tick, and you are listening to the
`jsonData` event to consume it, then it'll all be emitted right away in
that same tick.  If you want jsonData to be emitted in the next tick, then
